...
window.addEventListener("scroll", ()=>{
  ...
  laptop.style.transform = `translateX(calc(750vh - ${offsetY}px))`
  phones[1].style.transform = `translateX(calc(-575vh + ${offsetY}px))`
  phones[2].style.transform = `translateX(calc(-850vh + ${offsetY}px))`
})